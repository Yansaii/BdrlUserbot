...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern="whatanime$"))
