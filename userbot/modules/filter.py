...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"filters$"))
