...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"rmwelcome$"))
