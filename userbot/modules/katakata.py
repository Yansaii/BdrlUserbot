...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"semangat(?: |$)(.*)"))
async def _(event):
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"ywc(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(event.chat_id, "**Ok Sama Sama**")
    await event.delete()


@bot.on(bdrl_cmd(outgoing=True, pattern=r"jamet(?: |$)(.*)"))
async def _(event):
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"pp(?: |$)(.*)"))
async def _(event):
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"dp(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"so(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"nb(?: |$)(.*)"))
async def _(event):
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"met(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"war(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"wartai(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"kismin(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"ded(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"sokab(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"gembel(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"cuih(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"dih(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
        event.chat_id,
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"gcs(?: |$)(.*)"))
async def _(event):
    if event.chat_id in BLACKLIST_CHAT:
        return await event.edit("**Perintah ini Dilarang digunakan di Group ini**")
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"skb(?: |$)(.*)"))
async def _(event):
    await event.client.send_message(
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"virtual(?: |$)(.*)"))
async def _(event):
