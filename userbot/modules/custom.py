...
from userbot.utils import edit_delete, edit_or_reply, bdrl_cmd, reply_id


@bdrl_cmd(pattern=r"\#(\S+)")
...
@bdrl_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
