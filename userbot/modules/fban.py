...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"clearf$"))
