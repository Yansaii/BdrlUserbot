...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"app(?: |$)(.*)"))
async def apk(e):
    try:
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"calc(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"xcd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"remove(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    if event.is_private:
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"rnupload(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"grab(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"res(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"watch(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"bold(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"medibold(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"doublestruck(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"curbold(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"medi(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"cur(?: |$)(.*)"))
