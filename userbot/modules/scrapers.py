...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"img (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"currency ([\d\.]+) ([a-zA-Z]+) ([a-zA-Z]+)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"google ([\s\S]*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"wiki (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"ud (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"tts(?: |$)([\s\S]*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"tr(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(bdrl_cmd(pattern=r"lang (tr|tts) (.*)", outgoing=True))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"yt (\d*) *(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"yt(audio|video( \d{0,4})?) (.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"rbg(?: |$)(.*)"))
async def kbg(remob):
...
@bot.on(bdrl_cmd(pattern=r"ocr (.*)", outgoing=True))
async def ocr(event):
...
@bot.on(bdrl_cmd(pattern=r"decode$", outgoing=True))
...
@bot.on(bdrl_cmd(pattern=r"barcode(?: |$)([\s\S]*)", outgoing=True))
async def bq(event):
...
@bot.on(bdrl_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
...
@bot.on(bdrl_cmd(pattern=r"ss (.*)", outgoing=True))
