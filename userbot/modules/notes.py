...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"notes$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"rmbotnotes (.*)"))
