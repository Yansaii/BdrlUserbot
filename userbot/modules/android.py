...
@bot.on(bdrl_cmd(outgoing=True, pattern="magisk$"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(bdrl_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
